...
define internal void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17h5f7a965230da4ed2E"(i32* align 4 %self, i32 %other) unnamed_addr #0 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17ha2cacc3120a4d134E([0 x i8]* align 1 bitcast ([28 x i8]* @str.0 to [0 x i8]*), i32 28, %"core::panic::location::Location"* align 4 bitcast (<{ i8*, [12 x i8] }>* @alloc6 to %"core::panic::location::Location"*)) #5
  unreachable
}

; <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h4dc4bc885382cd9aE"(i32* align 4 %self, i32* align 4 %other) unnamed_addr #0 {
start:
  %_5 = load i32, i32* %other, align 4
; call <i32 as core::ops::arith::AddAssign>::add_assign
  call void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17h5f7a965230da4ed2E"(i32* align 4 %self, i32 %_5)
  br label %bb1
...
; call <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
  call void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h4dc4bc885382cd9aE"(i32* align 4 %x, i32* align 4 bitcast (<{ [4 x i8] }>* @alloc3 to i32*))
  br label %bb1
...
declare void @_ZN4core9panicking5panic17ha2cacc3120a4d134E([0 x i8]* align 1, i32, %"core::panic::location::Location"* align 4) unnamed_addr #4
